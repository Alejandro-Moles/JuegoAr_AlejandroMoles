...
{
	// System.Boolean InguzPings.AnimationHelper::INFINITE_LOOP
	bool ___INFINITE_LOOP_4;
	// System.Single InguzPings.AnimationHelper::duration
	float ___duration_5;
	// System.Boolean InguzPings.AnimationHelper::DESTROY_ON_END
	bool ___DESTROY_ON_END_6;
	// UnityEngine.GameObject[] InguzPings.AnimationHelper::all_particles
	GameObjectU5BU5D_tFF67550DFCE87096D7A3734EA15B75896B2722CF* ___all_particles_7;
	// System.Single InguzPings.AnimationHelper::start_time
	float ___start_time_8;
	// System.Boolean InguzPings.AnimationHelper::GO
	bool ___GO_9;
};
...
{
	// System.Single InguzPings.SelfDestruct::selfdestruct_in
	float ___selfdestruct_in_4;
};
...
// System.Void InguzPings.AnimationHelper::STOP_VFX()
...
#pragma clang diagnostic ignored "-Wunused-variable"
#endif
// System.Void InguzPings.AnimationHelper::Start()
...
{
	{
		...
		__this->___start_time_8 = L_0;
		// }
		return;
	}
}
// System.Void InguzPings.AnimationHelper::Update()
...
{
	{
		...
		bool L_0 = __this->___INFINITE_LOOP_4;
		if (L_0)
		{
			goto IL_002a;
		}
	}
	{
		...
		float L_2 = __this->___start_time_8;
		float L_3;
...
IL_000b:
	{
		...
		GameObjectU5BU5D_tFF67550DFCE87096D7A3734EA15B75896B2722CF* L_0 = __this->___all_particles_7;
		int32_t L_1 = V_0;
		NullCheck(L_0);
		int32_t L_2 = L_1;
...
IL_0021:
	{
		// for(int i = 0; i < all_particles.Length; i++)
		int32_t L_6 = V_0;
		GameObjectU5BU5D_tFF67550DFCE87096D7A3734EA15B75896B2722CF* L_7 = __this->___all_particles_7;
		NullCheck(L_7);
	...
	{
		// if (DESTROY_ON_END)
		bool L_8 = __this->___DESTROY_ON_END_6;
		if (!L_8)
		{
			goto IL_0044;
		}
...
// System.Void InguzPings.AnimationHelper::PLAY_VFX()
...
IL_001a:
	...
	}
	{
		...
		__this->___start_time_8 = L_8;
		// GO = true;
		__this->___GO_9 = (bool)1;
		// }
		return;
	}
}
// System.Void InguzPings.AnimationHelper::.ctor()
...
{
	{
		...
		__this->___INFINITE_LOOP_4 = (bool)1;
		// public float duration = 5.5f; //Fixed duration of the vfx.
		__this->___duration_5 = (5.5f);
		// public bool DESTROY_ON_END = true;
		__this->___DESTROY_ON_END_6 = (bool)1;
		// private float start_time = -100.0f;
		__this->___start_time_8 = (-100.0f);
...
#pragma clang diagnostic ignored "-Wunused-variable"
#endif
// System.Void InguzPings.SelfDestruct::Start()
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void SelfDestruct_Start_mB98347E3186954C4B7656889DBB8347619F6C5C0 (SelfDestruct_t32280DDABD40FC2A3E73A4D391418B4B88FB26AD* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		float L_0 = __this->___selfdestruct_in_4;
	...
	}
	{
		...
		float L_2 = __this->___selfdestruct_in_4;
		il2cpp_codegen_runtime_class_init_inline(Object_tC12DECB6760A7F2CBF65D9DCF18D044C2D97152C_il2cpp_TypeInfo_var);
...
// System.Void InguzPings.SelfDestruct::.ctor()
...
{
	{
		...
		__this->___selfdestruct_in_4 = (4.0f);
		MonoBehaviour__ctor_m592DB0105CA0BC97AA1C5F4AD27B12D68A3B7C1E(__this, NULL);
		return;
	}
}
